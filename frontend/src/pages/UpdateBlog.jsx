...
const UpdateBlog = () => {
  ...
  const updateBlogHandler = async () => {
    ...
    try {
      setLoading(true);
      const res = await axios.put(`https://bms-nwl5.onrender.com/api/v1/blog/${id}`, formData, {
  ...
  const togglePublishUnpublish = async (action) => {
    try {
      const res = await axios.patch(
        `https://bms-nwl5.onrender.com/api/v1/blog/${id}/toggle-publish`,
        { action },
        { withCredentials: true }
      );
  ...
  const deleteBlog = async () => {
    try {
      const res = await axios.delete(`https://bms-nwl5.onrender.com/api/v1/blog/delete/${id}`, {
        withCredentials: true,
      });
        ...
        <Card className="w-full bg-white dark:bg-gray-800 p-5 space-y-2">
          ...
          <div>
            ...
            <TiptapEditor
              ...
              onChange={setContent}
              uploadUrl="https://bms-nwl5.onrender.com/api/v1/blog/upload-image"
            />
          </div>
