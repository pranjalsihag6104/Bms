...
// const Sidebar = ({ user }) => {
//   return (
//     <div className='hidden mt-10 fixed md:block border-r-2 dark:bg-gray-800 bg-white border-gray-300 dark:border-gray-600 0 w-[310px] p-10 space-y-2 h-screen z-10'>
...
//           <>
//             {/* Reader-only */}
//             <NavLink to='/dashboard/liked' className={({ isActive }) =>
//               `text-2xl ${isActive ? "bg-gray-800 dark:bg-gray-900 text-gray-200" : "bg-transparent"} flex items-center gap-2 font-bold cursor-pointer p-3 rounded-2xl w-full`
//             }>
//               <FaHeart />
//               <span>Liked</span>
//             </NavLink>
//             <NavLink to='/dashboard/my-comments' className={({ isActive }) =>
//               `text-2xl ${isActive ? "bg-gray-800 dark:bg-gray-900 text-gray-200" : "bg-transparent"} flex items-center gap-2 font-bold cursor-pointer p-3 rounded-2xl w-full`
//             }>
//               <LiaCommentSolid />
//               <span>My-mments</span>
...
//             <NavLink to='/dashboard/saved' className={({ isActive }) =>
//               `text-2xl ${isActive ? "bg-gray-800 dark:bg-gray-900 text-gray-200" : "bg-transparent"} flex items-center gap-2 font-bold cursor-pointer p-3 rounded-2xl w-full`
//             }>
//               <MdBookmark />
//               <span>Saved </span>
